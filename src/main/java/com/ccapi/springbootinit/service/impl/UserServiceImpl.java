...
import static com.ccapi.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
import static com.ccapi.springbootinit.model.enums.UserRoleEnum.ADMIN;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "ccapi";
    ...
    public boolean isAdmin(HttpServletRequest request) {
        ...
        return user != null && ADMIN.getValue().equals(user.getUserRole());
    }
